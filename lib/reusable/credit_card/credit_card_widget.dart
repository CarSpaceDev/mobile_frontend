...
const Map<CardType, SvgFile> CardTypeIconAsset = {
  CardType.visa: SvgFile.Visa,
  CardType.americanExpress: SvgFile.Amex,
  CardType.mastercard: SvgFile.Mastercard,
  CardType.discover: SvgFile.Discover,
};
...
class CreditCardWidget extends StatefulWidget {
  const CreditCardWidget({
    ...
    this.height,
    this.width,
    this.cardBgColor = const Color.fromRGBO(10, 85, 30, 1),
...
class _CreditCardWidgetState extends State<CreditCardWidget> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Padding(
              ...
              child: CSText(
                widget.cardNumber.isEmpty || widget.cardNumber == null ? 'XXXX XXXX XXXX XXXX' : number,
  ...
  Widget getCardTypeImage(CardType cardType) => cardType == CardType.otherBrand
          ? Container()
          : SvgIcon(
  ...
  Widget getCardTypeIcon(String cardNumber) {
    ...
    switch (detectCCType(cardNumber)) {
      ...
      case CardType.discover:
        icon = Image.asset(
          'assets/card_icons/discover.png',
          height: 48,
          width: 48,
        );
        isAmex = false;
