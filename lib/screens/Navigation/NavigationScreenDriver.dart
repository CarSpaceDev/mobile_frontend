...
class _NavigationScreenDriverState extends State<NavigationScreenDriver> {
  ...
  final _farAway = WayPoint(name: "Far Far Away", latitude: 36.1175275, longitude: -115.1839524);
                      ...
                      RaisedButton(
                        ...
                        onPressed: () async {
                          ...
                          await _directions.startNavigation(
                              wayPoints: wayPoints,
                              options:
                                  MapBoxOptions(mode: MapBoxNavigationMode.drivingWithTraffic, simulateRoute: true, language: "en", units: VoiceUnits.metric));
                        },
                      ),
                      SizedBox(
                        width: 10,
