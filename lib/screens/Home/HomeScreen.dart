    ...
    locator<ApiService>()
      ...
      if (res.statusCode == 200) {
        ...
        for (var v in List<Map<String, dynamic>>.from(res.body)) {
          ...
          if (!checkIfWithinTime(v['availableFrom'], v['availableTo']))
            continue;
  ...
  Widget homeBottomNavBar() {
      ...
      child: FlatButton(
        ...
        child: Shimmer.fromColors(
          ...
          child: Container(
            ...
            child: Center(
                child: Text(
                    lotsInRadius.length == 0 ? "No lots nearby" : "PARK NOW",
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 16,
    ...
    return BottomNavigationBar(
      ...
      items: [
        ...
        BottomNavigationBarItem(
            icon: Icon(Icons.car_rental, color: Color.fromARGB(255, 0, 0, 0)),
