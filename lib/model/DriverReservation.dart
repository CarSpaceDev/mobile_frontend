...
enum DriverReservationStatus { COMPLETED, BOOKED, RESERVED }

enum DriverReservationType { RESERVATION, BOOKING }
...
class DriverReservation {
  ...
  String lotImage;
  String lotAddress;
  DriverReservationStatus status;
  DriverReservationType type;
  LatLng coordinates;
  ...
  DriverReservation.fromJson(Map<String, dynamic> json)
      : reservationId = json["reservationId"] as String,
        ...
        status = DriverReservationStatus.values[json['reservationStatus'] as int],
        type = DriverReservationType.values[json['reservationType'] as int],
