...
class Wallet extends Equatable {
  ...
  Wallet.fromDoc(DocumentSnapshot doc)
      : uid = doc.id,
        ...
        transactions = List<dynamic>.from(doc.data()["transactions"])
            .map((transaction) => WalletTransaction.fromJson(transaction))
            .toList();
  @override
  List<Object> get props => [uid, balance, transactions];
}
...
class WalletTransaction extends Equatable {
  ...
  @override
  List<Object> get props => [amount, fromId, toId, fromName, toName, timestamp, type, transactionRef];
}
